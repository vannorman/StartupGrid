...
<body onload="initialize()" class="demos ">
	...
	<!-- ### NON -CONTENT ### -->
		...
		<!-- Debug display -->
	 	<div id="debugDisplay" 
	 		style="position:fixed;top:0;right:0;width:200;height:50;border:1px solid red;z-index:1000000;">
	 	</div> 	
		...
		<!-- Plastic Wrap - hide clickable until load finishes -->
		<div id="plasticWrap"
	...
	<div id="FilterContainerIHateCSS">	
		...
		<!-- buttons -->
			<div id="login" class="button"><a class="janrainEngage" href="#">
				Log in</a>
			</div>
		...
		<div id="new-filter-container">
			...
			<div id="filter_0_title" class="filterTitle"><br>Location</div>
			...
			<div class="filterpos">
				...
				<div id="filter_1_title" class="filterTitle"><br>Industry</div>
					<div class="filterpos">
				    <div class="option-combo">
			...
			<div id="filter_1_title" class="filterTitle"><br>Seeking</div>
			<div class="filterpos">
		    <div class="option-combo">
		      <ul class="filter option-set clearfix multiple" data-filter-group="seeking"> 
				...
				<div id="filter_1_title" class="filterTitle"><br>Stage</div>
					<div class="filterpos">
				    <div class="option-combo">
			...
			<!-- Show/Hide buttons -->
				<div id="hideFilters" class="button2">
					Hide
				</div>
				<div id="showFilters" class="button2">
					Show
				</div>
			...
			<!-- Claim button -->
				<div id="ClaimStartup"><a class="janrainEngage" href="#">
					Claim Your Startup!
				</a></div>
...
<div id="containerBox">
		  ...
		  $tableNames = array("Startups_Clean");
			foreach ($tableNames as $tableName)
			{
				...
				while(($row = mysql_fetch_array($result)))
				{
					...
					//if ($i < 7)
					{	
						$founders = strtolower($row['Founders']);
						...
						echo  // done to create a line break in source
							...
							echo '<div class="foundersTitle">'.$founderNumber.'</div>';
							echo '<div class="leftText"><br><br>Seeking<br>Location<br>Stage</div>';
							echo '<div class="verticalLine"></div>';
							// logos are too slow. echo '<div class="logo" style="background-image:url(\''.$row['Logo_URL'].'\');background-size:100%;background-repeat:no-repeat;background-position:center;"></div>';
							
							
							// round 
							echo '<div class="established">EST. NOV-2011</div>';// . $row['Round'] . '</div>';
							
							// Name 
							echo '<div class="nameContainer">
								<div class="name">
									<a href="' . $row['Name_URL'] . '" target="_blank">' . $row['Name'] . '</a>
								</div>
							</div>';
							
							// Description
							$ellipsis = "";
							if (strlen($row['Description']) > 81) 
								$ellipsis = "...";
							$description = stripslashes(substr($row['Description'],0,82)). ' ' .	$ellipsis; // limit description length
							...
							// Founders
							echo '<div class="founders">'.$row['Founders'].'</div>';

							// Stage
							echo '<div class="stage">'.$row['Stage'].'</div>';
							
							// Seeking
							echo '<div class="seeking">'.$row['Seeking'].'</div>';							
	    ...
	    <!-- hardcoded raw HTML (for faster loading) from php output from 21-JAN-2011 -->
			...
			<!-- insert HTML here - ->  
			 <div name="eachStartup" class="color-shape Energy zero george cadena Aeterna Sol usa Idea"><div class="logo" style="background-image:url('http://www.startupchile.org/wp-content/uploads/2011/06/logo_aeternasol1-150x150.png');background-size:100%;background-repeat:no-repeat;background-position:center;"></div><div class="round">zero</div><a href="http://www.aeternasol.org" target="_blank"><div class="nameContainer">
							...
							</div><div class="description"><br><br><br>•<strong>Founders: </strong>Daniel Ponce Mauro Trigo<br><br>•<strong>Stage: </strong>Profitable</div></div><div name="eachStartup" class="color-shape Games Entertainment two vijay kailas rosario hernández błażej biesiada Ante Up united states Prototype"><div class="logo" style="background-image:url('http://cdn.younoodle.com/pictures/a5/f3/6f/show_4e456e732fad40_07349446.jpg');background-size:100%;background-repeat:no-repeat;background-position:center;"></div><div class="round">two</div><a href="" target="_blank"><div class="nameContainer">
								<div class="name jtextfill">
									<span>Ante Up</span>
								</div>
							</div><div class="description"><br><br><br>•<strong>Founders: </strong>Vijay Kailas Rosario Hernández Błażej Biesiada<br><br>•<strong>Stage: </strong>Prototype</div></div><div name="eachStartup" class="color-shape  two naysawn naderi miguel molina cecchetti Art Sumo canada "><div class="logo" style="background-image:url('http://www.artsumo.com/assets/images/small_logo.gif');background-size:100%;background-repeat:no-repeat;background-position:center;"></div><div class="round">two</div><a href="http://www.artsumo.com/" target="_blank"><div class="nameContainer">
								<div class="name jtextfill">
									<span>Art Sumo</span>
								</div>
							</div><div class="description"><br><br><br>•<strong>Founders: </strong>Naysawn Naderi Miguel Molina Cecchetti<br><br>•<strong>Stage: </strong></div></div><div name="eachStartup" class="color-shape Education Social two miguel molina cecchetti olivers de abreu heri rakotomalala Ateneo Digital, LLC united states Prototype"><div class="logo" style="background-image:url('http://www.ateneodigital.com/wp-content/themes/promo/images/logoateneo.png');background-size:100%;background-repeat:no-repeat;background-position:center;"></div><div class="round">two</div><a href="http://www.ateneodigital.com" target="_blank"><div class="nameContainer">
								<div class="name jtextfill">
									<span>Ateneo Digital, LLC</span>
								</div>
							</div><div class="description"><br><br><br>•<strong>Founders: </strong>Miguel Molina Cecchetti Olivers De Abreu Heri Rakotomalala<br><br>•<strong>Stage: </strong>Prototype</div></div><div name="eachStartup" class="color-shape  two greg wientjes Attract, Inc. united states "><div class="logo" style="background-image:url('');background-size:100%;background-repeat:no-repeat;background-position:center;"></div><div class="round">two</div><a href="" target="_blank"><div class="nameContainer">
								<div class="name jtextfill">
							...
							</div><div class="description"><br><br><br>•<strong>Founders: </strong>Francisco Larios Sanchez<br><br>•<strong>Stage: </strong>Growth</div></div><div name="eachStartup" class="color-shape  two deepkarn bedi adam dhanani gordon tindall david alvo Cloudeas LLC united states Prototype"><div class="logo" style="background-image:url('http://cdn.younoodle.com/pictures/42/cb/70/show_4e2e682ebeb386_70153602.jpg');background-size:100%;background-repeat:no-repeat;background-position:center;"></div><div class="round">two</div><a href="http://cloudeas.com" target="_blank"><div class="nameContainer">
								<div class="name jtextfill">
									<span>Cloudeas LLC</span>
								</div>
							</div><div class="description"><br><br><br>•<strong>Founders: </strong>Deepkarn Bedi Adam Dhanani Gordon Tindall David Alvo<br><br>•<strong>Stage: </strong>Prototype</div></div><div name="eachStartup" class="color-shape Web two mitul jain mihai voica prashant vaibhav CloudGate germany "><div class="logo" style="background-image:url('http://tctechcrunch.files.wordpress.com/2011/02/startup-chile.jpg');background-size:100%;background-repeat:no-repeat;background-position:center;"></div><div class="round">two</div><a href="" target="_blank"><div class="nameContainer">
								<div class="name jtextfill">
									<span>CloudGate</span>
								</div>
							...
							</div><div class="description"><br><br><br>•<strong>Founders: </strong>Alex Hughson<br><br>•<strong>Stage: </strong></div></div><div name="eachStartup" class="color-shape Commerce Web two vamshi mokshagundam ayan barua Credii india Prototype"><div class="logo" style="background-image:url('http://cdn.younoodle.com/pictures/17/61/cd/show_4e3f921da2def5_67098498.jpg');background-size:100%;background-repeat:no-repeat;background-position:center;"></div><div class="round">two</div><a href="" target="_blank"><div class="nameContainer">
								<div class="name jtextfill">
									<span>Credii</span>
								</div>
							</div><div class="description"><br><br><br>•<strong>Founders: </strong>Vamshi Mokshagundam Ayan Barua<br><br>•<strong>Stage: </strong>Prototype</div></div><div name="eachStartup" class="color-shape  two srinivasan rsudharshan s Cruns india "><div class="logo" style="background-image:url('http://tctechcrunch.files.wordpress.com/2011/02/startup-chile.jpg');background-size:100%;background-repeat:no-repeat;background-position:center;"></div><div class="round">two</div><a href="" target="_blank"><div class="nameContainer">
								<div class="name jtextfill">
									<span>Cruns</span>
								</div>
							...
							</div><div class="description"><br><br><br>•<strong>Founders: </strong>Michael Green<br><br>•<strong>Stage: </strong>Beta</div></div><div name="eachStartup" class="color-shape Computing  two camuel gilyadov Dazo israel Prototype"><div class="logo" style="background-image:url('http://tctechcrunch.files.wordpress.com/2011/02/startup-chile.jpg');background-size:100%;background-repeat:no-repeat;background-position:center;"></div><div class="round">two</div><a href="" target="_blank"><div class="nameContainer">
								<div class="name jtextfill">
									<span>Dazo</span>
								</div>
							</div><div class="description"><br><br><br>•<strong>Founders: </strong>Camuel Gilyadov<br><br>•<strong>Stage: </strong>Prototype</div></div><div name="eachStartup" class="color-shape Bio Web two guillermo medel roberto león jesper kampmann madsen Dentalink chile Growth"><div class="logo" style="background-image:url('http://cdn.younoodle.com/pictures/a3/a8/b1/show_4e20b075cdcdc0_02349810.jpg');background-size:100%;background-repeat:no-repeat;background-position:center;"></div><div class="round">two</div><a href="http://www.dentalink.cl" target="_blank"><div class="nameContainer">
								<div class="name jtextfill">
									<span>Dentalink</span>
								</div>
							...
							</div><div class="description"><br><br><br>•<strong>Founders: </strong>Nicolas Palacios<br><br>•<strong>Stage: </strong>Profitable</div></div><div name="eachStartup" class="color-shape Travel Games two gabriela mejia miguel torres luis loaiza andres granda ashwin bhambri luis bajana Escapeswithyou.com equador Prototype"><div class="logo" style="background-image:url('http://escapeswithyou.com/images/escapes.png');background-size:100%;background-repeat:no-repeat;background-position:center;"></div><div class="round">two</div><a href="http://www.escapeswithyou.com" target="_blank"><div class="nameContainer">
								<div class="name jtextfill">
									<span>Escapeswithyou.com</span>
								</div>
							</div><div class="description"><br><br><br>•<strong>Founders: </strong>Gabriela Mejia Miguel Torres Luis Loaiza Andres Granda Ashwin Bhambri Luis Bajana<br><br>•<strong>Stage: </strong>Prototype</div></div><div name="eachStartup" class="color-shape  two weiting tan Espy singapore "><div class="logo" style="background-image:url('http://tctechcrunch.files.wordpress.com/2011/02/startup-chile.jpg');background-size:100%;background-repeat:no-repeat;background-position:center;"></div><div class="round">two</div><a href="" target="_blank"><div class="nameContainer">
								<div class="name jtextfill">
									<span>Espy</span>
								</div>
							</div><div class="description"><br><br><br>•<strong>Founders: </strong>weiting tan<br><br>•<strong>Stage: </strong></div></div><div name="eachStartup" class="color-shape Web Travel two juan apparcel matías apparcel alejandro josé allende lecaros Find Your Place chile Prototype"><div class="logo" style="background-image:url('http://cdn.younoodle.com/pictures/42/12/d4/show_4e44668a06f447_33688190.jpg');background-size:100%;background-repeat:no-repeat;background-position:center;"></div><div class="round">two</div><a href="" target="_blank"><div class="nameContainer">
								<div class="name jtextfill">
									<span>Find Your Place</span>
								</div>
							</div><div class="description"><br><br><br>•<strong>Founders: </strong>Juan Apparcel Matías Apparcel Alejandro José Allende Lecaros<br><br>•<strong>Stage: </strong>Prototype</div></div><div name="eachStartup" class="color-shape  two sara zaccaro kevin kent First Born united states "><div class="logo" style="background-image:url('http://tctechcrunch.files.wordpress.com/2011/02/startup-chile.jpg');background-size:100%;background-repeat:no-repeat;background-position:center;"></div><div class="round">two</div><a href="" target="_blank"><div class="nameContainer">
								<div class="name jtextfill">
							...
							</div><div class="description"><br><br><br>•<strong>Founders: </strong>Sandaruwan Gunathilake Nayana Somaratna Orlando Rocha<br><br>•<strong>Stage: </strong>Growth</div></div><div name="eachStartup" class="color-shape Entertainment Social Games two michi kono brian kim  Memecup united states Prototype"><div class="logo" style="background-image:url('http://tctechcrunch.files.wordpress.com/2011/02/startup-chile.jpg');background-size:100%;background-repeat:no-repeat;background-position:center;"></div><div class="round">two</div><a href="" target="_blank"><div class="nameContainer">
								<div class="name jtextfill">
									<span>Memecup</span>
								</div>
							</div><div class="description"><br><br><br>•<strong>Founders: </strong>Michi Kono Brian Kim <br><br>•<strong>Stage: </strong>Prototype</div></div><div name="eachStartup" class="color-shape Internet  two federico vega nicolas vega diana sanchez mohamed al hajri  jesper kampmann madsen josé angel yánez MercadoTransporte Ltd uk Beta"><div class="logo" style="background-image:url('http://cdn.younoodle.com/pictures/29/8d/6a/show_4e38719a1a9b59_25883478.jpg');background-size:100%;background-repeat:no-repeat;background-position:center;"></div><div class="round">two</div><a href="http://www.MercadoTransporte.com" target="_blank"><div class="nameContainer">
								<div class="name jtextfill">
							...
							</div><div class="description"><br><br><br>•<strong>Founders: </strong>Ozan Onay<br><br>•<strong>Stage: </strong></div></div><div name="eachStartup" class="color-shape Entertainment Information Technology Mobile Travel  two christian daly eric kriegstein rikin mantriucla test  SeatUP united states Prototype"><div class="logo" style="background-image:url('http://tctechcrunch.files.wordpress.com/2011/02/startup-chile.jpg');background-size:100%;background-repeat:no-repeat;background-position:center;"></div><div class="round">two</div><a href="" target="_blank"><div class="nameContainer">
								<div class="name jtextfill">
									<span>SeatUP</span>
								</div>
							</div><div class="description"><br><br><br>•<strong>Founders: </strong>Christian Daly Eric Kriegstein Rikin Mantriucla test <br><br>•<strong>Stage: </strong>Prototype</div></div><div name="eachStartup" class="color-shape Commerce Legal two alfredo sfeir Shellcatch united states "><div class="logo" style="background-image:url('http://tctechcrunch.files.wordpress.com/2011/02/startup-chile.jpg');background-size:100%;background-repeat:no-repeat;background-position:center;"></div><div class="round">two</div><a href="" target="_blank"><div class="nameContainer">
								<div class="name jtextfill">
							...
							</div><div class="description"><br><br><br>•<strong>Founders: </strong>Justin Bates Michael Emo Blake Ringeisen <br><br>•<strong>Stage: </strong></div></div><div name="eachStartup" class="color-shape Social Retail two stefan paulsen alejandro matamala sebastián rodríguez  césar soto vitryn.com chile Prototype"><div class="logo" style="background-image:url('http://tctechcrunch.files.wordpress.com/2011/02/startup-chile.jpg');background-size:100%;background-repeat:no-repeat;background-position:center;"></div><div class="round">two</div><a href="http://www.vitryn.com" target="_blank"><div class="nameContainer">
								<div class="name jtextfill">
									<span>vitryn.com</span>
								</div>
							</div><div class="description"><br><br><br>•<strong>Founders: </strong>Stefan Paulsen Alejandro Matamala Sebastián Rodríguez  César Soto<br><br>•<strong>Stage: </strong>Prototype</div></div><div name="eachStartup" class="color-shape Travel Retail two chris crompton WanderDeal united states Beta"><div class="logo" style="background-image:url('http://cdn.younoodle.com/pictures/c6/4d/68/show_4e41ed484109e1_63100236.jpg');background-size:100%;background-repeat:no-repeat;background-position:center;"></div><div class="round">two</div><a href="http://WanderDeal.com" target="_blank"><div class="nameContainer">
								<div class="name jtextfill">
							...
							</div><div class="description"><br><br><br>•<strong>Founders: </strong>Joe Kiernan Thomas Lyle<br><br>•<strong>Stage: </strong></div></div><div name="eachStartup" class="color-shape Web two bernardo joselevich  Whelse argentina Prototype"><div class="logo" style="background-image:url('http://cdn.younoodle.com/pictures/57/06/c7/show_4e6404665eda29_79002919.jpg');background-size:100%;background-repeat:no-repeat;background-position:center;"></div><div class="round">two</div><a href="http://www.whelse.com" target="_blank"><div class="nameContainer">
								<div class="name jtextfill">
									<span>Whelse</span>
								</div>
							</div><div class="description"><br><br><br>•<strong>Founders: </strong>Bernardo Joselevich <br><br>•<strong>Stage: </strong>Prototype</div></div><div name="eachStartup" class="color-shape Commerce Mobile two erisvaldo junior marcus oliveira  Yupi Studios brazil "><div class="logo" style="background-image:url('http://tctechcrunch.files.wordpress.com/2011/02/startup-chile.jpg');background-size:100%;background-repeat:no-repeat;background-position:center;"></div><div class="round">two</div><a href="" target="_blank"><div class="nameContainer">
								<div class="name jtextfill">
							...
							</div><div class="description"><br><br><br>•<strong>Founders: </strong>PeterJan Celis<br><br>•<strong>Stage: </strong>Idea</div></div>				<!-- END raw HTML -->
	...
	<!-- JQuerY -->							<script src="http://www.fractalgames.com/bin/js/jquery-1.6.4.min.js"></script>
	<!-- Jeditable -->					<script src="http://www.fractalgames.com/bin/js/jquery.jeditable.js" type="text/javascript" charset="utf-8"></script> 
		
																														
	<!-- mousewheel - ->					<script src="http://www.fractalgames.com/bin/js/jQuery_mousewheel_plugin.js"></script>-->	
	<!-- Text Fill - -> 					<script src="http://www.fractalgames.com/bin/js/jquery-textFill-0.1.js"></script>-->
		
	
	<!-- Isotope -->						<script src="http://www.fractalgames.com/bin/js/jquery.isotope.js"></script>
	<!-- Infinite Scroll -->		<script src="http://www.fractalgames.com/bin/js/infinite.scroll.js"></script>




	<!-- poof effect - ->				<script src="http://www.fractalgames.com/bin/js/poof.js"></script>
...
<script>
	...
	// the items you will be loading more of
	 ...
	 // possibly for use with infinite scroll.
	 /*
	function get20 (filterTerms) {
 			$.ajax({
        type: "POST",
        url: "php/Get20.php",
        data: "filterTerms="+filterTerms
        	+"&tableName=Startups_Clean",
        success: function(newElements){  
        	// Add to isotope here.
        	$container.isotope( 'appended', $( newElements ) ); 
           alert('Success! blah..data wuz '+newElements);
        }  
    });
